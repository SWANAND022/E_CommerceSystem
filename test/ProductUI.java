...
public class ProductUI {
		...
		public static void main(String[] args) {
			...
			Integer productId;
			String productName;
			String productType;//Grocery or Accessories or Household item
			Double price;
			...
			while(exit==false) {
				...
				case 1:
					...
					System.out.print("Enter rating for the product: A number between 1 to 5");
				...
				case 2:
					...
					if(plist!=null && plist.isEmpty()!=true) {
						...
						System.out.println("Unable to show products at this moment!! Please try again later!!!");
					break;
				...
				case 5:
					...
					plist=pimpl.searchByName(productName);
					if(plist!=null && plist.isEmpty()!=true) {
